...
#ao.add_argument("--threshold", help="NPMTs trigger threshold", action="store_true")
# con "store true" l'argomento threshold viene accettato anche senza aggiungere argomenti. Senza questa opzione, uno dovrebbe lanciare con --threshold 1

args = ao.parse_args()

#ao.add_argument("-a","--abc", default=235,help="abcdef")
#args = ao.parse_args()


# python3 Genera.py be7 [howmany] [events per run] [species]
...
if( Species == 'mono'):
    lineSpecies ='gun --particles ' + ParticleType + ' --kinetic-energy ' + ParticleEnergy
